...
export const appointmentForm=[
    ...
    },
    {
        ...
        required: true,
        type: "dropdown",
        defaultValue: appointmentStatuses.find(status=>status.value==="SCHEDULED").value,
        disabled:{
            register:true,
            update:false
        },
    ...
    },
    {
        ...
        required: true,
        type: "dropdown",
        defaultValue: appointmentOccurrences.find(status=>status.value==="ONCE").value,
        disabled:{
            register:false,
            update:true
        },
...
export const registerAppointmentFields=appointmentForm.map((field)=>{
    ...
    return ({
        ...rest,disabled:disabled.register
    })  
})
